...
;		invoke printf, CStr("usage: SetMtrr <WC|UC>",13,10)
		invoke printf, CStr("SetMtrr v1.3 (C) Japheth 2005-2020",10)
...
;		invoke printf, CStr("          -d disable MTRRs.",10)
		...
		invoke printf, CStr("          -u=ssss-eeee set type of memory range to UC ([00])",10)
...
;--- read the SYSCFG (system configuration register) (#C00)
	lea edi, regs
	mov [edi].REGS._eax, 0
